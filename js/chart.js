...
$(document).ready(function() {
  quarterback_rating = new Highcharts.Chart({
    ...
    series: [{
      ...
      name: 'Luck',
      data: [52.9,107.5, 75.7,81.0]
    }, {
      name: '2012 Manning',
      data: [129.2, 58.5, 83.0,130.0,116.2]
    }]
  });
  ...
  cmp_percentage = new Highcharts.Chart({
    ...
    series: [{
      ...
      name: 'Luck',
      data: [51.1,64.5, 47.8,56.4]
    }, {
      name: '2012 Manning',
      data: [73.1, 64.9, 50.0,78.9,70.5]
    }]
  });
  ...
  yards = new Highcharts.Chart({
    ...
    series: [{
      ...
      name: 'Luck',
      data: [309,224,313,362]
    }, {
      name: '2012 Manning',
      data: [253,241,330,338,345]
    }]
  });
