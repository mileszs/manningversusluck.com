...
$(document).ready(function() {
  quarterback_rating = new Highcharts.Chart({
    ...
    series: [{
      ...
      name: 'Luck',
      data: [52.9,107.5, 75.7,81.0,51.3,74.8,89.5, 105.6, 80.1]
    }, {
      name: '2012 Manning',
      data: [129.2, 58.5, 83.0,130.0,115.4,129.0,138.9,105.8,103.1]
    }]
  });
  ...
  cmp_percentage = new Highcharts.Chart({
    ...
    series: [{
      ...
      name: 'Luck',
      data: [51.1,64.5, 47.8,56.4,50.0,55.2,68.4,62.5, 69.2]
    }, {
      name: '2012 Manning',
      data: [73.1, 64.9, 50.0,78.9,70.5,80.0,73.3,77.1,71.1]
    }]
  });
  ...
  yards = new Highcharts.Chart({
    ...
    series: [{
      ...
      name: 'Luck',
      data: [309,224,313,362,280,186,297,433,227]
    }, {
      name: '2012 Manning',
      data: [253,241,330,338,337,309,305,291,301]
    }]
  });
  ...
  interceptions = new Highcharts.Chart({
    ...
    series: [{
      ...
      name: 'Luck',
      data: [3,0,1,1,2,0,1,0,1]
    }, {
      name: '2012 Manning',
      data: [0,3,0,0,0,1,0,2,0]
    }]
  });
  ...
  touchdowns = new Highcharts.Chart({
    ...
    series: [{
      ...
      name: 'Luck',
      data: [1,2,2,2,0,0,1,2,0]
    }, {
      name: '2012 Manning',
      data: [2,1,2,3,3,3,3,3,1]
    }]
  });
});
